       ...
       if(result1[0].length == 0){
           ...
           if(result[0].length == 1){
             ...
             if(diff > 10){
                   ...
                   res.render('login/reActive',{user,pin,alert});
             }
             else{
...
module.exports = {register,login,active,get_pass,post_pass,pass,dash,details,change};